...
<link href="/shop1/Public/Admin/css/general.css" rel="stylesheet" type="text/css" />
<link href="/shop1/Public/Admin/css/main.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    <img src="/shop1/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/shop1/Public/Admin/images/sort_desc.gif"/>    </th>
  ...
  <tr>
    ...
    <td align="center"><img src="/shop1/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop1/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop1/Public/Admin/images/yes.gif"  /></td>
    <td align="center"><img src="/shop1/Public/Admin/images/yes.gif"  /></td>
    ...
    <td align="center"><span >100</span></td>
        ...
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/shop1/Public/Admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="编辑"><img src="/shop1/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/shop1/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('admin/goods/del',array('goods_id'=>$v['goods_id']));?>"  title="回收站"><img src="/shop1/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/shop1/Public/Admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
