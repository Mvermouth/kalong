var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var canvas = {
			...
			config: {
				...
				color: canvasConfig.color || "0, 0, 0",
				stroke: canvasConfig.stroke || "0,0,0",
	...
	function canvasSize(canvas){
		...
		canvas.height = window.innerWeight*0.9 || document.documentElement.clientHeight*0.9 || document.body.clientHeight*0.9;
		// canvas.width = 500;
		// canvas.height = 500;
	}
