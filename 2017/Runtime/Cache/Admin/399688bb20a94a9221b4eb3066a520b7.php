...
<ul>
  <li class="explode" key="02_cat_and_goods" name="menu">
    商品管理        <ul>
          <li class="menu-item"><a href="<?php echo U('Admin/Pic/piclist');?>" target="main-frame">商品列表</a></li>
          <li class="menu-item"><a href="<?php echo U('Admin/Pic/picadd');?>" target="main-frame">添加新商品</a></li>

          <li class="menu-item"><a href="<?php echo U('Admin/Tc/tcadd');?>" target="main-frame">商品分类</a></li>
        </ul>
      </li>
