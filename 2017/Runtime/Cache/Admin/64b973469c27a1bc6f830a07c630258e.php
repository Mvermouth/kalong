...
<div class="main-div">
  <form action="<?php echo U('Admin/Tc/tcadd');?>" method="post" name="theForm" enctype="multipart/form-data">
  <table width="100%" id="general-table">
      <tr>
        <td class="label">分类名称:</td>
        <td>
          <input type='text' name='tc_name' maxlength="20" value='' size='27' /> <font color="red">*</font>
        </td>
      </tr>
      <tr>
          <td class="label">地区名称:</td>
          <td>
              <input type='text' name='area_name' maxlength="20" value='' size='27' /> <font color="red">*</font>
          </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <!--<td>-->
          <!--<textarea name='intr' rows="6" cols="48"></textarea>-->
        <!--</td>-->
      </tr>
      </table>
