    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="<?php echo U('Admin/goods/goodsadd');?>" method="post" name="theForm">
            ...
            <table width="90%" id="general-table" align="center">
                ...
                <tr>
                    <td class="label">
                        <a href="#" title="点击此处查看提示信息"><img src="/sword/Public/Admin/images/notice.gif" width="16"
                                                            height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号：
                    </td>
            ...
            <table width="90%" id="mix-table" style="display:none" align="center">
                ...
                <tr>
                    <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/sword/Public/Admin/images/notice.gif"
                ...
                <tr id="alone_sale_1">
                    ...
                    <td id="alone_sale_3"><input type="checkbox" name="is_on_sale" value="1" checked="checked"/>
                        打勾表示允许销售，否则不允许销售。
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="label">
                        <a href="#" title="点击此处查看提示信息"><img src="/sword/Public/Admin/images/notice.gif" width="16"
                                                            height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注：
                    </td>
