    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <td align="center">
                    <a href="#" target="_blank" title="查看"><img src="/sword/Public/Admin/images/icon_view.gif" width="16"
                                                                height="16" border="0"/></a>
                    <a href="#" title="编辑"><img src="/sword/Public/Admin/images/icon_edit.gif" width="16" height="16"
                                                border="0"/></a>
                    <a href="#" title="复制"><img src="/sword/Public/Admin/images/icon_copy.gif" width="16" height="16"
                                                border="0"/></a>
                    <a href="<?php echo U('admin/goods/del',array('goods_id'=>$v['goods_id']));?>" title="回收站"><img
                            src="/sword/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0"/></a>
                    <a href="#" title="货品列表"><img src="/sword/Public/Admin/images/icon_docs.gif" width="16" height="16"
                                                  border="0"/></a></td>
