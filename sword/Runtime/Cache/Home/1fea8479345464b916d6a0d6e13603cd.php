...
<div class="block2">
    ...
    <form action="<?php echo U('Home/Order/done');?>" method="post" name="theForm" id="theForm">
        ...
        <table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1"
               width="100%">
            <tbody>
            <tr>
            ...
            <!--<tr>-->
                <!--<td colspan="7" class="f1 f14b" style="text-align:right;" bgcolor="#ffffff">-->
                    <!--购物金额小计 ￥3010.00元，比市场价 ￥3612.00元 节省了 ￥602.00元 (17%)-->
                <!--</td>-->
            <!--</tr>-->
            </tbody>
        </table>
        ...
        <div id="ECS_ORDERTOTAL">
            <table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1"
                ...
                <tr>
                    <td align="right" bgcolor="#ffffff">
                        商品总价: <font class="f1 f14b">￥<?php echo ($allMoney); ?>元</font>
                    </td>
                </tr>
                <tr>
                    <td align="right" bgcolor="#ffffff"> 应付款金额: <font class="f1 f14b">￥<?php echo ($allMoney); ?>元</font>
                    </td>
                </tr>
                </tbody>
            </table>
        ...
        <div style="margin:8px auto;" align="center">
            <!--<a href="<?php echo U('Home/Order/done');?>">-->
                <input src="/sword/Public/Home/images/bnt_subOrder.gif" type="image">
                <!--提交-->
            <!--</a>-->
