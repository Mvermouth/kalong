    ...
    <div class="reg clearfix ">
        <div class="us_login" style="float:left;">
            <div class="mbox" style="width:485px; height:430px; ">
                <div class="login_tit blank" style="margin-top:15px;"><strong style="font-size:18px;">登录</strong> &nbsp;&nbsp;&nbsp;&nbsp;已经注册，请在此登录
                </div>
                <div class="contentNew">
                    <div class="l_box">
                        ...
                        <form action="" method="post" name="loginForm" id="loginForm">
                            <label> <span>用户名</span>
                                <input type="text" class="inputBg" name="usename" size="25">
                            </label>
                            <label> <span>密码</span>
        ...
        <div class="us_login" style="float:left;">
            <div class="mbox" style="width:485px; height:430px;">
                <div class="reg2_tit blank" style="width:485px; margin-top:15px;"><strong
                        style="font-size:18px;">注册</strong> &nbsp;&nbsp;&nbsp;&nbsp; 新用户？ 立即注册，享受多重惊喜。
                </div>
