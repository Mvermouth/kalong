...
<div class="block1 clearfix">
    ...
    <div id="pageLeft" class="fl">
        <h1 style="background:url(/sword/Public/Home/images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px;">
            <a href=""><font style="color:#000; font-size:14px;">所有分类</font></a></h1>
        <div class="mod1 mod2 blank" id="historybox">
            <span class="lb"></span><span class="rb"></span>
            <div class="cagegoryCon clearfix">
                <?php if(is_array($tree)): foreach($tree as $key=>$t): if($t["lv"] == 0): ?><dl>
                            <dt><a href=""><?php echo ($t["cat_name"]); ?></a></dt>
                            <dd class="clearfix">
                                <?php if(is_array($tree)): foreach($tree as $key=>$s): if($t[cat_id] == $s[parent_id]): ?><p><a href="<?php echo U('Home/Cat/cat',array('cat_id'=>$s['cat_id']));?>" title="CDMA手机" class="txtdot"><?php echo ($s["cat_name"]); ?></a></p><?php endif; endforeach; endif; ?>
                            </dd>
                        </dl><?php endif; endforeach; endif; ?>
            </div>
            <div class="blank"></div>
        </div>
        <h1 class="mod2tit" style="background:url(/sword/Public/Home/images/sdgg.gif) repeat-x; height:27px; color:#000">
            销售排行</h1>
        <div class="mod1 mod2 blank" id="topbox">
            ...
            <ul id="top10">
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">1.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥68元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/3_thumb_G_1368081034405.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">2.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥2000元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/24_thumb_G_1370338453422.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">3.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥983元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/12_thumb_G_1241965978410.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">4.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥2298元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/9_thumb_G_1370338145445.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">5.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥5999元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/22_thumb_G_1370338695095.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">6.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥280元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/20_thumb_G_1370338655638.jpg" alt=""
                                        align="left"></a>
                ...
                <li>
                    <div class="first">
                        <div class="fl">
                            <font style="color:#F00; font-weight:bold">7.</font> <a href=""
                                                                                    title="">ECSHOP模板中心68ecs...</a>
                        </div>
                        <div class="fr"><b class="f1">￥399元</b></div>
                    </div>
                    <div class="last">
                        <a href=""><img src="/sword/Public/Home/images/8_thumb_G_1241425513488.jpg" alt=""
                                        align="left"></a>
        ...
        <h1 class="mod2tit" style="background:url(themes/68ecshop_hechafree/images/sdgg.gif) repeat-x; height:27px;">
            <font style="color:#000">浏览历史</font></h1>
        <div id="history_div">
            <div class="mod1 mod2 blank" id="historybox">
                <span class="lb"></span><span class="rb"></span>
    ...
    <div id="pageRight" class="fr">
        <div class="goodsTitle clearfix blank"><span class="fl">商品列表</span>
            <form method="GET" class="sort fr" name="listform">
                显示方式：
                <a href=""><img src="/sword/Public/Home/images/display_mode_list.gif" alt=""></a>
                <a href=""><img src="/sword/Public/Home/images/display_mode_grid_act.gif" alt=""></a>
                <a href=""><img src="/sword/Public/Home/images/display_mode_text.gif" alt=""></a>&nbsp;&nbsp;
                <a href=""><img src="/sword/Public/Home/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
                <a href=""><img src="/sword/Public/Home/images/shop_price_default.gif" alt="按价格排序"></a>
                <a href=""><img src="/sword/Public/Home/images/last_update_default.gif" alt="按更新时间排序"></a>
            ...
            <form name="compareForm" action="" method="post">
                <div class="clearfix grid">
                    <?php if(is_array($goodslist)): foreach($goodslist as $key=>$g): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
                            <div class="imgbox1"><a
                                    href="<?php echo U('Home/goods/goods',array('goods_id'=>$g['goods_id']));?>">
                                <img src="/sword/Public/.<?php echo ($g[thumb_img]); ?>"></a></div>
                            <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$g['goods_id']));?>"
                               title="ECSHOP模板中心68ecshop.com测试商品"><?php echo ($g[goods_name]); ?></a><br>
        ...
        <div class="pagebar">
            <form name="selectPageForm" action="http://free.68ecshop.com/hechaw2013/category.php" method="get">
                <div id="pager">
                    总计 <b><?php echo ($count); ?></b> 个记录 <?php echo ($page); ?>
                </div>
            </form>
        </div>
    </div>
