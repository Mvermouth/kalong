...
<div class="page-header clearfix">
    <div class="block1 clearfix" style="position:relative;">
        <div class="logo fl"><a href="./index.php.htm" title=""><img src="/sword/Public/Home/images/logo.gif" width="311"
                                                                     height="55" alt=""></a></div>
        <div class="btMap">
            <div class="search ">
...
<div style="position:relative; width:1190px; margin:0 auto;">
    <object width="1190" height="360"><img src="/sword/Public/Home/images/banner.png" style='margin:0 0 0 250px;' alt=""/>
    </object>
    <div class="blank"></div>
</div>
<div class="blank" style="position:relative; width:1190px; margin:0 auto;">
    <div style=" width:230px; position:absolute;top:-373px; *top:-368px;left:0; height:359px; background:#fff;">
        <h1 style="background:#6aa724; height:27px; line-height:27px; padding-left:10px;"><a href=""><font
                style="color:#fff; font-size:14px;">所有分类</font></a></h1>
...
<div class="block1 clearfix">
    <div id="pageLeft" class="fr">
            ...
            <div class="mod1">
                ...
                <div class="mod1con shop_notice">
                    ...
                    <div class="mod2con clearfix">
                        <ul>
                            <li style="width:250px; margin-right:20px; display:inline; height:25px; line-height:25px;"
                                class="fl"><a href="" title="产品质量保证 " class="txtdot">产品质量保证</a></li>
                            <li style="width:250px; margin-right:20px; display:inline; height:25px; line-height:25px;"
                                class="fl"><a href="" title="如何分辨原装电池" class="txtdot">如何分辨原装电池</a></li>
                            <li style="width:250px; margin-right:20px; display:inline; height:25px; line-height:25px;"
                                class="fl"><a href="" title="投诉与建议 " class="txtdot">投诉与建议</a></li>
                            <li style="width:250px; margin-right:20px; display:inline; height:25px; line-height:25px;"
                                class="fl"><a href="" title="选机咨询 " class="txtdot">选机咨询</a></li>
                            <li style="width:250px; margin-right:20px; display:inline; height:25px; line-height:25px;"
                                class="fl"><a href="" title="网站故障报告" class="txtdot">网站故障报告</a></li>
                            <ul>
                            </ul>
                        </ul>
                    </div>
        ...
        <div class="w230" style="">
            <div class="ads">
                <table cellpadding="0" cellspacing="0">
                    <tbody>
                    <tr>
                        <td><a href="" target="_blank"><img src="/sword/Public/Home/images/1370400501175025752.jpg"
                                                            width="230" height="100" border="0"></a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="w230">
            <h1 class="mod2tit"
                style="background:url(themes/68ecshop_hechafree/images/sdgg.gif) repeat-x; height:27px; color:#000">
                最近浏览
            </h1>
            ...
            <div class="mod1 mod2 blank" id="topbox">
                ...
                <ul id="top10">
                    <?php if(is_array($his)): foreach($his as $k=>$h): ?><li>
                            ...
                            <!-- <div class="last">
                             <a href=""><img src="/sword/Public/Home/images/3_thumb_G_1368081034405.jpg" alt="" align="left"></a>
        ...
        <div class="w230">
            <h1 class="mod2tit"
                style=" position:relative;background:url(themes/68ecshop_hechafree/images/sdgg.gif) repeat-x; height:27px; color:#000">
                品牌专卖<a href="./brand.php.htm" class="more"><font style="color:#000">全部品牌</font></a></h1>
            <div class="mod1 mod2 blank brandboxs1">
                <span class="lb"></span><span class="rb"></span>
                <div class="brandsL clearfix">
                    <a href=""><img src="/sword/Public/Home/images/1240803062307572427.gif" alt="诺基亚 (7)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240802922410634065.gif" alt="摩托罗拉 (1)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240803144788047486.gif" alt="多普达 (1)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240803247838195732.gif" alt="飞利浦 (1)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240803352280856940.gif" alt="夏新 (1)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240803412367015368.gif" alt="三星 (2)"></a>
                    <a href=""><img src="/sword/Public/Home/images/1240803482283160654.gif" alt="索爱 (2)"></a>
                </div>
            </div>
        ...
        <div class="w230 ">
            ...
            <h1 style="background:url(themes/68ecshop_hechafree/images/sdgg.gif) repeat-x; height:27px; line-height:27px; padding-left:10px; font-size:14px; color:#000">
                发货查询</h1>
    ...
    <div id="pageRight" class="fl clearfix">
        ...
        <div class="blank">
            ...
            <div class="recommendContent entry-content" id="show_best_area">
                <div class="goodsbox1">
                    <div class="imgbox1"><a href="./goods.php-id=5.htm"><img
                            src="/sword/Public/Home/images/5_thumb_G_1370338478388.jpg"
                            alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
                    <a href="./goods.php-id=5.htm" title="ECSHOP模板中心68ecshop.com测试商品">ECSHOP模板中心68ecs...</a><br>
                    <font class="goodspice market">￥24元</font>
                    <b class="f1">￥20元</b><br>
                </div>
                <div class="goodsbox1">
                    <div class="imgbox1"><a href="./goods.php-id=7.htm"><img
                            src="/sword/Public/Home/images/7_thumb_G_1370338401919.jpg"
                            alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
                ...
                <div class="goodsbox1">
                    <div class="imgbox1"><a href="./goods.php-id=22.htm"><img
                            src="/sword/Public/Home/images/22_thumb_G_1370338695095.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a>
                    </div>
                ...
                <div class="goodsbox1">
                    <div class="imgbox1"><a href="./goods.php-id=19.htm"><img
                            src="/sword/Public/Home/images/19_thumb_G_1370338674278.jpg" alt="ECSHOP模板中心68ecshop.com测试商品"></a>
                    </div>
        ...
        <div class="">
            ...
            <div class="recommendContent entry-content" id="show_new_area">
                ...
                <div class="goodsbox1">
                    <div class="imgbox1"><a href="./goods.php-id=3.htm"><img
                            src="/sword/Public/Home/images/3_thumb_G_1368081034405.jpg"
                            alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
...
<div class="block tc" style="margin-bottom:20px;">
    ...
    <br>
    共执行 5 个查询，用时 0.021133 秒，在线 17 人，Gzip 已禁用，占用内存 3.415 MB<img src="./api/cron.php-t=1452023217" alt=""
                                                               style="width:0px;height:0px;"><br>
</div>
</body>
</html>